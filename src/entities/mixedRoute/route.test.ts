import { Ether, Token, WETH9, CurrencyAmount, Currency } from '@monoswap-labs/sdk-core'
import { Route as V3RouteSDK, Pool, FeeAmount, TickMath, encodeSqrtRatioX96 } from '@monoswap-labs/v3-sdk'
import { MixedRoute, RouteV3 } from '../route'
import { Protocol } from '../protocol'
import { Route as V2RouteSDK, Pair } from '@monoswap-labs/v2-sdk'
