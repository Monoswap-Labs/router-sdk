import { sqrt, Token, CurrencyAmount, TradeType, WETH9, Ether, Percent, Price } from '@monoswap-labs/sdk-core'
...
import { Pair, Route as V2RouteSDK } from '@monoswap-labs/v2-sdk'
