...
import { Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress, WETH9 } from '@monoswap-labs/sdk-core'
import { abi } from '@uniswap/swap-router-contracts/artifacts/contracts/interfaces/ISwapRouter02.sol/ISwapRouter02.json'
import { Trade as V2Trade } from '@monoswap-labs/v2-sdk'
import {
  encodeRouteToPath,
  FeeOptions,
  MethodParameters,
...
/**
 * Represents the Monoswap V2 + V3 SwapRouter02, and has static methods for helping execute trades.
 */
